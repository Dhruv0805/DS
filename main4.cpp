...
public:
    ...
    {
        Image image = LoadImage("gameTool/Food.png");
...
public:
    ...
    Frem frem = Frem();
    Sound eat = LoadSound("gameTool/eat.mp3");
    Sound stating = LoadSound("gameTool/Stating.mp3");
    Sound Over = LoadSound("gameTool/GameOver.mp3");
    float scoar = 0.00;
    bool Running = true;
    bool puase = false;
    ...
    void Draw()
    {
        ...
        if(!puase){
                    DrawText("Enter P to start Game",3 * cellsiez,cellsiez * (cellcount - 1),cellsiez,BLACK);
                }
...
int main()
{
    ...
    {   if(IsKeyPressed(KEY_P)){game.puase=true;}
